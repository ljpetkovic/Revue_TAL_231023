...
Comme dans la section \ref{subsec:inter_OCR-IMPACT-NER}, nous utilisons le modèle spaCy\_lg pour l'annotation automatique de la Réf. dont nous nous servons comme Vérité Terrain et les transcriptions de ROC corrigées automatiquement.
