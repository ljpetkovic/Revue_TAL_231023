...
%\footnote{Pour plus de détails sur ce modèle : \url{https://habr.com/en/articles/346618/}}
 (grain mot), dont une partie des fonctionnalités est mise à disposition gratuitement sur le web.
...
\subsection{Typologie des contaminations de corrections de la ROC issues de l'analyse manuelle}
