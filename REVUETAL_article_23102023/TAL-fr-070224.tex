...
\address{%
\fup{*} Observatoire des textes, des idées et des corpus (\textsc{ObTIC}), Sorbonne Université, Paris, France
%\\
...
\input{04-01_IMPACT_OCR_NER.tex}

\input{04-02_IMPACT_CORR_OCR_NER.tex}
