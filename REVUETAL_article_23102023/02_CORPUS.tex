...
\begin{table}[H]
    ...
    \caption{Statistiques sur le corpus small-TGB-fr (\texttt{spaCy\_lg} est le modèle large de \texttt{spaCy}. Cette dernière colonne indique le nombre total des EN).}
    \label{tab:TGBFra}
\end{table}
