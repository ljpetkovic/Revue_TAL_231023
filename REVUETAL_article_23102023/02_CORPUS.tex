...
\begin{table}[H]
    ...
    \caption{Statistiques sur le corpus TGB. (\texttt{spaCy\_lg} : modèle large de \texttt{spaCy}. La dernière colonne indique le nombre total des EN).}
    \label{tab:TGBFra}
\end{table}
...
\begin{table}[h!]
   ...
   \begin{subtable}[h]{1\textwidth}
    ...
    \end{subtable}
    \caption{Statistiques sur les corpus ELTeC. La dernière colonne indique le nombre total d'EN.
