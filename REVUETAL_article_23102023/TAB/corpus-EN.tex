...
\hline
 &
  \multicolumn{5}{c||}{Kraken} &
  \multicolumn{5}{c|}{Tess.} \\ \cline{2-11} 
\multirow{-2}{*}{} &
  \multicolumn{1}{c|}{Brut} &
  \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}Jspll \\ préentraîné\end{tabular}} &
...
\multicolumn{1}{|c|}{\textit{small}-ELTec-en} &
  \multicolumn{1}{r|}{3 121} &
  \multicolumn{1}{r|}{1 691} &
  \multicolumn{1}{r|}{-46 \%} &
  \multicolumn{1}{r|}{1 446} &
  -54 \% &
  \multicolumn{1}{r|}{2 653} &
  \multicolumn{1}{r|}{2 072} &
  \multicolumn{1}{r|}{-22 \%} &
...
CER médian &
  ...
  \multicolumn{1}{c|}{0,256} &
  \multicolumn{2}{c|}{0,261} &
  \multicolumn{2}{c|}{0,265} \\ \hline\hline
\multicolumn{1}{|c|}{\textit{small}-ELTec-fr} &
  \multicolumn{1}{r|}{7 062} &
  \multicolumn{1}{r|}{5 320} &
  \multicolumn{1}{r|}{-25 \%} &
  \multicolumn{1}{r|}{\textbf{6 758}} &
  \textbf{-5 \%} &
  \multicolumn{1}{r|}{4 888} &
  \multicolumn{1}{r|}{4637} &
  \multicolumn{1}{r|}{-5 \%} &
  \multicolumn{1}{r|}{\textbf{4 921}} &
  \textbf{+0,7 \%} \\ \hline
CER médian & 
  ...
  \multicolumn{2}{c|}{0,054} &
  \multicolumn{2}{c|}{0,055} \\ \hline\hline
\multicolumn{1}{|c|}{\textit{small}-ELTec-pt} &
  \multicolumn{1}{r|}{10 110} &
  \multicolumn{1}{r|}{N/A} &
  \multicolumn{1}{r|}{N/A} &
  \multicolumn{1}{r|}{6 147} &
  -39 \% & 
